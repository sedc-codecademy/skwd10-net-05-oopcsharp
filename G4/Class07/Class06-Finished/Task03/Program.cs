...
namespace Task03
{
    class Program
    {
        ...
        static User FindUser(User[] usersArray, string userName, string password = null)
        {
        ...
        static void Login(User[] usersArray, string username, string password)
        {
        ...
        static void Register(User[] usersArray, int id, string username, string password)
        {
        ...
        static void PrintUsers(User[] usersArray)
        {
